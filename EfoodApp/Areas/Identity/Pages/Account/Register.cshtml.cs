...
namespace EfoodApp.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            Input = new InputModel()
            {
                ...
                PreguntasSeguridad = DS.PreguntasSeguridad.Select(q => new SelectListItem { Value = q, Text = q }).ToList()
            };
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                Input.PreguntasSeguridad = DS.PreguntasSeguridad.Select(q => new SelectListItem { Value = q, Text = q }).ToList();
